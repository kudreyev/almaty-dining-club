    ...
    <section className="px-5">
      <div className="mx-auto max-w-3xl py-6 md:py-8">
        ...
        <div className="mt-5 flex flex-wrap items-center gap-3">
          ...
          <a
            href="#venues"
            className="inline-flex items-center justify-center rounded-lg bg-primary px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2"
          >
            К заведениям
          </a>
        </div>
